  ...
  return (
    <>
      ...
      <Container>
        ...
        <Description>This is the Patient dashboard</Description>
        <CardContainer>
          <Card to="/Patient" className="doctor-card">
            <CardIcon><FaCalendarCheck /></CardIcon>
            <CardTitle>Appointments</CardTitle>
            <CardText>Check appointments here</CardText>
          </Card>
          <Card to="/Patient" className="front-desk-card">
            <CardIcon><FaVial /></CardIcon>
            <CardTitle>Test</CardTitle>
            <CardText>Check for your test results</CardText>
          </Card>
          <Card to="/Patient" className="data-entry-card">
